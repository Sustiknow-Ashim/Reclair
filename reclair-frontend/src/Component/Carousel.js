        ...
        <div className="container mx-auto">
            ...
            <div className="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4">
                ...
                >
                    ...
                    <Slider >
                        <Slide index={0}>
                            <ImageWithZoom src={project[0]?.image} />
                        </Slide>
                        <Slide index={1}>
                            <ImageWithZoom src={project[1]?.image} />
                        </Slide>
                        <Slide index={2}>
                            <ImageWithZoom src={project[2]?.image} />
                        </Slide>
                        <Slide index={3}>
                            <ImageWithZoom src={project[3]?.image} />
                        </Slide>
                ...
                <CarouselProvider className="lg:block hidden" naturalSlideWidth={150} naturalSlideHeight={175} isIntrinsicHeight={true} totalSlides={4} isPlaying={true} visibleSlides={4} step={2} infinite={true} interval={3000} >
                        ...
                        <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                            <Slider>
                                <div id="slider" className="h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                                        ...
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <div className="flex h-full items-end pb-6">
                                                    <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">{project[0]?.name}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </Slide>
                                    <Slide index={1}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            <img src={project[1]?.image} alt="sitting area" className="object-cover object-center w-full rounded-lg" />
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <div className="flex h-full items-end pb-6">
                                                    <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">{project[1]?.name}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </Slide>
                                    <Slide index={2}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <div className="flex h-full items-end pb-6">
                                                    <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">{project[2]?.name}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </Slide>
                                    <Slide index={3}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <div className="flex h-full items-end pb-6">
                                                    <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">{project[3]?.name}</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </Slide>
